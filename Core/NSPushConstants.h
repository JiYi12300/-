...
#define PUSHER_LOOP_PREVENTION_WINDOW 25   // recent bulletin contents to scan
#define PUSHER_LOOP_PREVENTION_THRESHOLD 10 // repeats of the same content to block
